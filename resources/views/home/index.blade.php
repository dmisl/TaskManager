    ...
    <div class="menu__parent">
        <div class="menu">
            <div class="card shadow">
                <a class="menu__element yellow__background goals">Мої цілі</a>
                <a class="menu__element green__background tasks">Сьогоднішні завдання</a>
                <a class="menu__element blue__background week">Мій тиждень</a>
                <a class="menu__element red__background completed">Виконані завдання</a>
                <a class="menu__element grey__background settings"><p style="z-index: 10;">Налаштування</p></a>
                <a class="menu__element black__background logout">Вийти з системи</a>
