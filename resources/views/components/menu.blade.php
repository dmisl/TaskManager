<div class="menu__parent">
    <div class="menu">
        <div class="card shadow">
            <a href="{{ route('goal.index') }}" class="menu__element yellow__background goals"><p>Мої цілі</p></a>
            <a href="#tasks" class="menu__element green__background tasks"><p>Сьогоднішні завдання</p></a>
            <a href="{{ route('goal.show') }}" class="menu__element blue__background week"><p>Мій тиждень</p></a>
            <a href="{{ route('stats.index') }}" class="menu__element red__background completed"><p>Виконані завдання</p></a>
