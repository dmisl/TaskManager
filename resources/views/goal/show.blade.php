...
// ADDITIONAL FUNCTIONS
    ...
    // PRIORITY BAR HANDING
        function create__priority__bar(parent)
        {
            tippy(parent.querySelector('.priority__parent .flex'), {
                placement: 'right',
                content: 'Виберіть',
                sticky: true,
                interactive: true,
            ...
            let priority__flex = parent.querySelector('.priority__parent .flex')
            priority__flex._tippy.show()
            let priorities = parent.querySelectorAll('.priority')
            ...
            priorities.forEach((priority, index) => {
                priority.addEventListener('click', function () {
                    ...
                    console.log(parent.querySelector('.task__priority').value)
                })
