            ...
            <div class="task__create">
                ...
                <form action="{{ route('task.store') }}" method="POST">
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="Посадити редиску">
                    </div>
                    <div class="form-item">
                        <div class="d-flex justify-content-between">
                        ...
                        <textarea class="form-control" name="desc" id="desc" maxlength="100" placeholder="Не забуди піти до діда взяти якоїсь лопати та й граблі шоби шось почати" rows="3"></textarea>
                    </div>
                    <div class="form-submit">
                        <button><p>Створити</p></button>
                    </div>
                </form>
            </div>
